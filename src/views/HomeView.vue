                    ...
                    <v-col cols="12" sm="8">
                      <v-list-item three-line>
                        <v-list-item-content>
                          ...
                          <v-list-item-title class="headline mb-1 white--text">$8520.50</v-list-item-title>
                  ...
                  <v-row>
                    <v-col cols="12" sm="8">
                      <v-list-item three-line>
                        <v-list-item-content>
                          <div class="mb-4">
                            <v-btn fab color="pink lighten-1" elevation="0">
                  ...
                  <v-row>
                    <v-col cols="12" sm="8">
                      <v-list-item three-line>
                        <v-list-item-content>
                          <div class="mb-4">
                            <v-btn fab color="orange lighten-1" elevation="0">
              ...
              <v-card>
                ...
                <v-app-bar flat color="rgba(0,0,0,0)">
                  ...
                  <v-toolbar-title class="title black--text ml-2">
                    Send Bitcoin <span class="caption"><br>To Bitcoin Address</span>
                  </v-toolbar-title>
                  <v-spacer></v-spacer>
                ...
                <v-app-bar flat color="rgba(0,0,0,0)">
                  <v-btn fab color="orange lighten-4" elevation="0">
                    <v-icon color="green">fas fa-yen-sign</v-icon>
                  </v-btn>
                  <v-toolbar-title class="title black--text ml-2">
                  ...
                  <v-icon color="green" class="ml-2">fas fa-long-arrow-alt-down</v-icon>
                </v-app-bar>
              </v-card>
            </v-col>
            <v-col cols="12" sm="6">
                    ...
                    <v-list-item three-line>
                      <v-list-item-content>
                        ...
                        <v-row>
                          ...
                          <v-col cols="12" sm="6">
                            <v-list-item-subtitle class="grey--text mt-8">2.5578</v-list-item-subtitle>
